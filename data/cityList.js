window.cityList = {
    ...
    "Germany": [
        "Berlin", "Hamburg", "Munich", "Cologne", "Frankfurt", "Stuttgart", "Düsseldorf", "Leipzig", "Dresden",
        "Hannover", "Nuremberg", "Duisburg", "Bochum", "Wuppertal", "Bielefeld", "Bonn", "Münster", "Karlsruhe",
        "Mannheim", "Augsburg", "Wiesbaden", "Gelsenkirchen", "Braunschweig", "Kiel", "Aachen", "Chemnitz",
        "Halle", "Magdeburg", "Freiburg", "Oberhausen", "Erfurt", "Mainz", "Rostock", "Kassel", "Hagen",
        "Saarbrücken", "Potsdam", "Lübeck", "Heidelberg", "Würzburg", "Regensburg", "Osnabrück", "Oldenburg"
    ],
    "Netherlands": [
        "Amsterdam", "Rotterdam", "The Hague", "Utrecht", "Eindhoven", "Tilburg", "Groningen", "Almere",
        "Breda", "Nijmegen", "Enschede", "Apeldoorn", "Haarlem", "Arnhem", "Amersfoort", "Dordrecht",
        "'s-Hertogenbosch", "Zwolle", "Leiden", "Maastricht", "Ede", "Emmen", "Oss", "Alkmaar", "Hilversum",
        "Delft", "Venlo", "Deventer", "Gouda", "Leeuwarden", "Heerlen", "Helmond"
    ]
};